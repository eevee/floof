...
<section>
    ...
    <%lib:secure_form url="${request.route_url('controls.persona.remove')}">
    <fieldset>
        <dl>
            <dt>New Persona</dt>
            <dd>
                <a href="${request.route_url('account.login')}" class="persona" title="Sign-in with Persona to add a new email address to this account">
