...
<h1>
    ${lib.icon('user-nude')} <a href="${request.route_url('users.profile', name=target_user.name)}">${target_user.name}</a>
...
<div>
    <a href="${request.route_url('controls.rels.watch', target_user=target_user.name)}">
